...
- Terminal messages now show `HH:MM:SS`, and the first message after reconnecting starts a new entry instead of being appended to an earlier received message.
