...
var pl = map[string]string{
	...
	"bbs_help":    "H pomoc | L lista | I informacje | LM lista | LN/N nowe | LS wyslane | LB biuletyny | R <id> czytaj | RE <id> odpowiedz | S/SP <znak@BBS> prywatna | SB <obszar> biuletyn | FS <id> forwarding | K <id> usun | PROFILE | NAME | HOMEBBS | QTH | LOC | CONV | LANG PL/EN | B powrot\r\n",
