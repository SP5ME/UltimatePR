...
func New(mode, callsign, locator, qth, language string, stationSSID, nodeSSID, bbsSSID uint8) Config {
	...
	c := Config{
		...
		BBS: BBS{Enabled: full, Listen: "127.0.0.1:8023", ForwardListen: "127.0.0.1:8024", Database: "/var/lib/ultimatepr/bbs.json", Title: call + " BBS", Callsign: call, SSID: bbsSSID, SysopCallsign: call, Language: lang, MaxSessions: 10,
			Housekeeping: BBSHousekeeping{BulletinRetentionDays: 90, PersonalRetentionDays: 180, LogRetentionDays: 30},
		...
		GameHall: GameHall{Enabled: false, Callsign: call, SSID: 14, Language: lang, InviteTimeoutSeconds: 120},
	}
