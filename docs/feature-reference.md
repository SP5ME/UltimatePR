...
| Forwarding | Classical TAPR text exchange | Delegated to mailbox | Private FWD1 over TCP | TAPR SID `H$`, `SP`/`SB`, `OK`/`NO`, `R:`, Ctrl-Z and `F>`; authentication, full reverse forwarding and cross-tests remain |
